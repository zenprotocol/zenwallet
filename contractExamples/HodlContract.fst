(* NAME_START:HODL Until: 1532015400000UL (15:50 UTC):NAME_END *)
...
// replace `"%uint64"` with eg. `123456789UL`
let maturityTimestamp = 1532015400000UL

//replace `"%pkhash"` with eg. `"0a1b2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1b"`
let returnAddress = "fb367c92bba6e5aeda3d9c4a06a449f10d5e0a854fc5fecd7a905e817db53e51"
...
let hodl (txSkel: txSkeleton) (contractId: contractId)
                  : CR.t `cost` 182 = //16
...
let withdraw (txSkel: txSkeleton) ({timestamp=timestamp}: context)
    ...
    | None, _ -> RT.autoFailw "Message body must include WithdrawAmount in the following format: 'WithdrawAmount: 10ZP'"
...
let main (txSkel: txSkeleton) (context: context) (contractId: contractId)
    ...
    | "HODL" -> hodl txSkel contractId |> autoInc
