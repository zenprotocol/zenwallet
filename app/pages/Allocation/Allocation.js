...
class Allocation extends Component<Props, State> {
  ...
  get getData() {
    ...
    if (!isEmpty(allocationVote)) {
      ...
      //const updateVote = [{ amount: '11', count: '1421380000000' }, { amount: '21', count: '3411380000000' }, { amount: '23', count: '1431380000000' }, { amount: '41', count: '1521380000000' }, { amount: '42', count: '1321380000000' }, { amount: '97', count: '1401380000000' }]
      return updateVote
    }
    return [{
      amount: 0,
        ...
        <Flexbox flexDirection="column" className="allocation-container">
          <Flexbox className="page-title" flexDirection="column">
            ...
            <h3>
              ...
              aliquam ullamcorper risus a malesuada. Maecenas euismod at erat in varius.
              <br />
              Donec placerat lacinia sem, eget tempus dolor egestas
              sit amet Praesent a massa massa. Vivamus massa est.
            </h3>
            <hr />
